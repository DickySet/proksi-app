<template>
    ...
    <k-list strong inset>
        <k-list-item title="About Account" class="font-bold"/>
        <router-link :to="{ name: 'personal-information' }">
            <k-list-item link title="Personal Information">
                <template #media>
...
<script setup>
    ...
    import { faUser, faKey, faCircleInfo, faRightFromBracket, faPenToSquare } from '@fortawesome/free-solid-svg-icons';
